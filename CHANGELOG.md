...
- Five baselines: naive persistence, MLP, LSTM, Transformer and gradient
  boosting. 100,000 training windows for the window-based models and 150,000
  rows for the MLP, three seeds (42, 7, 123), identical per-site test rows.
...
- README: training budgets corrected (MLP uses 150,000 rows, not 100,000 windows);
  pooled shortest-horizon skill corrected to +0.052 (the earlier +0.054 was the
  MLP row rather than the pooled mean over the nine available 15-minute cells).

[1.0.0]: https://github.com/shahoismael/crossclimatepv/releases/tag/v1.0.0
[1.1.0]: https://github.com/shahoismael/crossclimatepv/releases/tag/v1.1.0
